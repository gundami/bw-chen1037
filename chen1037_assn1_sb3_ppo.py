"""
CST8509 Assignment 1 - Stable-Baselines3 PPO Agent for BlocksWorld-v1
Chen1037 (Algonquin ID)

Trains a PPO agent on the BlocksWorld-v1 environment (6-digit state that
...
def main():
    ...
    print("Training PPO on BlocksWorld-v1 ...")
    ...
    ax1.set_title("PPO Returns per Episode - BlocksWorld-v1")
    ax1.legend()
    ...
    ax2.set_title("PPO Steps per Episode - BlocksWorld-v1")
    ax2.legend()

    plt.tight_layout()
    os.makedirs("screenshots", exist_ok=True)
    filename = os.path.join("screenshots", "PPO_BlocksWorld_v1.png")
